...
VALUES
 ...
 ('Robert', 'Philips', '6477654321', 'robert@email.com', 'test8', '6301 Silver Dart Dr, Mississauga', 't', 'https://miro.medium.com/max/500/0*3MwGeUV66MiBrm4_.jpg', 't', 'car'),
 ...
 ('Cristian', 'Button', '6477654321', 'chris@email.com', 'test10', '288 Bremner Blvd, Toronto', 't', 'https://miro.medium.com/max/500/0*Zr9VJLJld-l8v_Dr.jpg', 't', 'bicycle'), --change back to unavailable after building layout
 ...
 ('Gilbert', 'Stace', '6477654321', 'gilbert@email.com', 'test12', '200 Bay St, Toronto,', 't', 'https://upload.wikimedia.org/wikipedia/en/2/2d/Lakitu.png', 't', 'truck'), --change back to unavailable after building layout
