...
VALUES
 ...
 ('Cameron', 'Rutherford', '6477665421', 'cameron@email.com', 'test9', '662 King St W, Toronto', 't', 'https://images.unsplash.com/photo-1554151228-14d9def656e4?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60', 't', 'bicycle'),
 ('Cristina', 'Button', '6477654321', 'chris@email.com', 'test10', '288 Bremner Blvd, Toronto', 't', 'https://images.unsplash.com/photo-1595026530842-ccc7d3f71723?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60', 't', 'bicycle'), --change back to unavailable after building layout
 ...
 ('Gilbert', 'Stace', '6477654321', 'gilbert@email.com', 'test12', '200 Bay St, Toronto,', 't', 'https://images.unsplash.com/photo-1541647376583-8934aaf3448a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60', 't', 'truck'), --change back to unavailable after building layout
 ...
 ('Steven', 'Garcia', '6477654321', 'steven@email.com', 'test14', '60 Carl Hall Rd, North York', 't', 'https://images.unsplash.com/photo-1553946550-4b8f3eea5451?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60', 't', 'car'),
 ('Antony', 'Cooper', '4162222222', 'antony@email.com', 'test15', '1 Blue Jays Way, Toronto', 't', 'https://images.unsplash.com/photo-1548535537-3cfaf1fc327c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60', 't', 'car');